class FlightData:
    """FlightData class to structure flight data."""
...
def find_cheapest_flight(data):
    ...
    nr_stops = first_flight["itineraries"][0]["segments"][0]["numberOfStops"]
    ...
    for flight in data["data"]:
        ...
        if price < lowest_price:
            lowest_price = price
            nr_stops = flight["itineraries"][0]["segments"][0]["numberOfStops"]
